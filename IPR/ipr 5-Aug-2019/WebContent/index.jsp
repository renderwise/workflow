		...
		<div id="mainchild">
			<form action="Savedetails" method="post">
						...
						<div class="container">
							...
							<div class="row">
								...
								<div class="col-2">
									...
									<input type="text" name="UZA" size="8">
								...
								<div class="col-2">
									...
									<input type="text" name="LZA" size="8"> <input
								...
								<div class="col-2">
									...
									<input type="text" name="CST" size="8">
							...
							<div class="row">
								...
								<div class="col-2">
									...
									<input type="text" name="UATT" size="8">
								...
								<div class="col-2">
									...
									<input type="text" name="LATT" size="8">
								...
								<div class="col-2">
									...
									<input type="text" name="TST" size="8">
							...
							<div class="row">
								...
								<div class="col-2">
									...
									<input type="text" name="UA" size="8">
								...
								<div class="col-2">
									...
									<input type="text" name="LA" size="8">
							...
							<div class="row">
								...
								<div class="col-2">
									...
									<input type="text" name="UP" size="8">
								...
								<div class="col-2">
									...
									<input type="text" name="LP" size="8">
							...
							<div class="row">
								...
								<div class="col-2">
									...
									<input type="text" name="UTA" size="8">
								...
								<div class="col-2">
									...
									<input type="text" name="LTA" size="8">
							...
							<div class="row">
								...
								<div class="col-1">
									...
									<input type="radio" name="START" value="YES">YES
					...
					<div id="child10">
						...
						<div id="iprposit<%=k%>">
							<div id="ipr<%=k%>">
								<label for="attherate<%=k%>">@</label><input type="text"
									...
									name="thickness<%=k%>" size="4" style="border: none;"><br>
								<img src="images/ipr1.png" id="imgipr<%=k%>">
							</div>
						...
						<div id="iprpositL<%=a%>">
							...
							<div id="iprL<%=a%>">
								...
								<br> <input type="text" name="thicknessL<%=a%>" size="4"
									style="border: none;"><br> <label
									for="attherateL<%=a%>">@</label><input type="text"
				...
				<div id="section11">
					<div id="child11">
						<h4>Remarks:</h4>
						<textarea rows="4" cols="120" name="remarks"></textarea>
						<br>
					</div>
				</div>
				<div id="section12">
