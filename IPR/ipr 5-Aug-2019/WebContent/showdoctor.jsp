...
<body>
	...
	<div id="mainpage">
		<div id="mainchild">
			...
			<div id="section10">
				<div id="child10">
					<img src="images/teethnew1.png" alt="TEETH" id="imgteeth">
					<%
						for (int i = 0; i < 32; i++) {
					%>
					<div id="posit<%=i + 1%>">
			...
			<div id="section12">
				<div id="child12">
					<pre id="line">
						<h5>Note:-The Attachment Transfer template has a layer of isofolan sheet beneath it, 
Which is to be removed before using the Template.</h5><ul><li>Refinements may be required.</li>
<li>Kindly ensure proper attachments transfer and their placements through-out the treatment.</li>
<li>Use hand strips and/or Inter proximal reduction burs for Inter proximal reductions.</li>
<li>Kindly ensure adequate patient compliance (minimum wear 20-22hrs./day)</li>
<li>The Attachment Transfer Template has a layer of isoflan sheet beneath it, which has to be removed before using the template.</li></ul>
</pre>
			<div id="section13">
				<div id="child13">
					<div class="container">
